...
Explore category-wise distribution (General, OBC, SC, ST)

Compare state-level performance to spot high and low-performing regions

Check Aadhaar and mobile number registration completeness

📊 Key KPIs

199M Total Beneficiaries
...
Growth trends across years and quarters
...
Found clear seasonal and quarterly variations in registrations

Category-wise insights helped highlight demographic trends and focus areas
...
Advanced visualizations (maps, stacked bars, line charts)

Data cleaning and transformation

📂 Project Files

indira gandhi national widow pension schema.pbix – Power BI report

https://www.data.gov.in/resource/indira-gandhi-widow-pension-scheme-ignwps-beneficiaries-abstract-during-fy-2023-24 – Dataset used
...
Explore the pages, visuals, and insights at your own pace
...
Gaps in Aadhaar and mobile compliance

State-wise variations that matter for policy decisions
...
Kundan kr ray
Email: mahiray655@gmail.com

LinkedIn:https://www.linkedin.com/in/kundankrray/
